...
/// * Medienverarbeitung: Erstellung von Thumbnails für Bildanhänge.
/// * Sicherheits-Cleanup: Temporär entschlüsselte Dateien werden nach dem Öffnen automatisch gelöscht.
///
/// **Sicherheitskonzept:**
/// Der symmetrische Schlüssel (_entryKey) wird nur im Arbeitsspeicher gehalten und beim
/// Verlassen der Seite sicher gelöscht. Anhänge werden erst bei Bedarf (Lazy Loading) entschlüsselt.
class DetailViewModel extends BaseViewModel {
  ...
  Future<void> initialize(int id) async {
    ...
    try {
      ...
      // 3. Hauptdaten mittels AES entschlüsseln
