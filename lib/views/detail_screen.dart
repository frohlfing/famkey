...
class _DetailScreenState extends State<DetailScreen> {
    ...
    /// Initialisiert den Screen und lädt die Daten des spezifischen Tresor-Eintrags
    /// über das ViewModel, sobald der erste Frame gerendert wurde.
    @override
    void initState() {
        super.initState();
                        ...
                        : SizedBox(
                            ...
                            child: ListView.separated(
                                ...
                                itemBuilder: (ctx, index) {
                                    ...
                                    if (!user.isVerified) {
                                        leadingIcon = Tooltip(message: 'Person ist nicht verifiziert!', child: leadingIcon);
                                    }
