...
class _EditScreenState extends State<EditScreen> {
    ...
    /// Initialisiert den Screen, verknüpft das ViewModel und lädt die Daten 
    /// des gewählten Eintrags (falls vorhanden) in die Text-Controller.
    @override
    void initState() {
        super.initState();
    ...
    /// 
    /// Diese Methode stellt sicher, dass die Textfelder (insbesondere für 
    /// Passwort und Kategorie) aktualisiert werden, wenn diese Werte 
    /// durch Logik im ViewModel (z. B. den Generator) geändert werden.
    void _onViewModelChanged() {
        ...
        ); // UI Refresh für dynamischen Titel
    }
