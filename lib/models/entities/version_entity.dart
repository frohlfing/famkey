...
class VersionEntity {
  ...
  VersionEntity({this.id = 1, required this.major, required this.minor, required this.patch, required this.updatedAt});

  /// Konvertiert eine [VersionEntity] in eine Map (z.B. für SQLite oder JSON).
  Map<String, dynamic> toMap() {
    return {'id': id, 'major': major, 'minor': minor, 'patch': patch, 'updated_at': updatedAt.toIso8601String()};
  }
