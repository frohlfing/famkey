...
|            | PUT        | /users/{user_uuid}/password     | ja         | BODY: { salt, encrypted_private_key, master_key_timestamp }                                                                                                                                                                                                 | (204) -                                                                                                                                                                                                                                                                      | Aktualisiert Salt und Private Key nach Änderung des Master-Passworts.         |
