...
import de.frohlfing.famkey.famkey.R
import androidx.autofill.inline.v1.InlineSuggestionUi

/**
 * Der Android-Autofill-Service von FamKey.
 *
 ...
 * `android.service.autofill.AutofillService` erben. Sobald der Nutzer FamKey
 ...
 *   Daten speichern? (FamKey ignoriert das aktuell.)
 *
 ...
 *
 * FamKey verwendet "Dataset-Level-Auth": Der Nutzer klickt auf den
 * "FamKey"-Vorschlag → FamKey öffnet sich zur Auswahl → Der Nutzer wählt
 ...
 */
class FamKeyAutofillService : AutofillService() {
    ...
    override fun onFillRequest(request: FillRequest, cancellationSignal: CancellationSignal, callback: FillCallback) {
        ...
        val presentation = RemoteViews(packageName, R.layout.autofill_suggestion).apply {
            setTextViewText(R.id.autofill_label, "FamKey")
        }
        ...
        //
        // Dataset = ein Vorschlag mit konkreten Feldwerten. Da FamKey erst
            ...
            Dataset.Builder().apply {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R && spec != null) {
                    try {
                        ...
                        val slice = InlineSuggestionUi.newContentBuilder(pendingIntent).setTitle("FamKey").build().slice
        ...
        // Android zeigt jetzt die FamKey-Bubble im Autofill-Dropdown.
     ...
     * und Android fragt, ob FamKey die eingegebenen Daten speichern möchte.
     *
     * FamKey speichert Einträge nur manuell – daher hier kein Implementierung.
     */
     ...
     *
     * Außerdem wird die Domain der aktuellen Website ermittelt, damit FamKey
    ...
    companion object {
        /** Intent-Action: Signalisiert, dass FamKey im Autofill-Modus geöffnet werden soll. */
        const val ACTION_AUTOFILL_PICK = "de.frohlfing.famkey.AUTOFILL_PICK"
         ...
         * Nutzer einen Eintrag in FamKey ausgewählt hat.
         *
